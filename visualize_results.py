...
Прави 9 фигури, секоја е замислена да оди директно во извештајот:
  ...
  3. radar_comparison.png       - "spider" дијаграм - нормализирана мултиметричка споредба
...
# ---------------------------------------------------------------------------
# 3. Radar / spider дијаграм - нормализирана мултиметричка споредба
...
def plot_radar_comparison():
    ...
    ax.grid(alpha=0.3)
    ax.set_title(
        "Мултиметрички профил (нормализирано низ методите)\n"
