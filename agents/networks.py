...
само дообработена и приспособена за мултиагентен контекст (VDN mixer-от
...
class MultiAgentReplayBuffer:
    """
    Ист принцип како ReplayBuffer погоре, само прилагодено за
    мултиагентен случај - тука зачувувам "заеднички" (joint) чекори: за секој
